 ...
 * 
 */
package com.zuk.media.javacv.rtmp;
...
//		 String inputFile = "C:\\bbg.mp4";
		 String inputFile = "rtmp://183.2.169.127:1935/hls/record1";
//		 String inputFile = "rtsp://183.2.169.127:1935/cam/realmonitor?channel=1&subtype=0";
		 // Decodes-encodes
	...
	private static void recordByFrame(FFmpegFrameGrabber grabber, FFmpegFrameRecorder recorder, Boolean status)
		...
		try {//建议在线程中使用该方法
			...
			recorder.start();
			Frame frame = null;
			CanvasFrame cframe = new CanvasFrame("pull.");
